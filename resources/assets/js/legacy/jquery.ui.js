            ...
            (t.widget.bridge = function (i, n) {
                ...
                t.fn[i] = function (a) {
                    ...
                    return (
                        (a =
                            !r && h.length
                                ? t.widget.extend.apply(null, [a].concat(h))
                                : a),
                        r
                            ? this.each(function () {
                                  var s,
            ...
            (t.Widget.prototype = {
                ...
                _trigger: function (e, i, s) {
                    ...
                    return (
                        ...
                        !(
                            (t.isFunction(a) &&
                                a.apply(this.element[0], [i].concat(s)) ===
                                    !1) ||
                ...
                for (
                    ...
                    for (x = '', this.maxRows = 4, D = 0; U[1] > D; D++) {
                        if (
                            ...
                            if (
                                ((P += "<div class='ui-datepicker-group"),
                                U[1] > 1)
                            )
                                switch (D) {
                                    case 0:
                        ...
                        for (
                            ...
                            for (
                                ...
                                (O = m
                                    ? m.apply(t.input ? t.input[0] : null, [E])
                                    : [!0, '']),
                                    (F = E.getMonth() !== Z),
                                    (R =
                                        (F && !_) ||
            ...
            (t.effects.effect.size = function (e, i) {
                ...
                'show' === p && a.show(),
                    ...
                    ('box' === g || 'both' === g) &&
                        (o.from.y !== o.to.y &&
                            ((_ = _.concat(u)),
                            (a.from = t.effects.setTransition(
                                a,
                                u,
                                o.from.y,
                                a.from,
