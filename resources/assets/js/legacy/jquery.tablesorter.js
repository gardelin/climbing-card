            ...
            var L = (A.tablesorter = {
                    ...
                    if (
                        ...
                        (t.hasInitialized = !1),
                            ...
                            r.namespace
                                ? (r.namespace =
                                      '.' +
                                      r.namespace.replace(L.regex.nonWord, ''))
                                : (r.namespace =
                                      '.tablesorter' +
                            ...
                            r.$table.children('caption').length &&
                                ((o = r.$table.children('caption')[0]).id ||
                                    (o.id = r.namespace.slice(1) + 'caption'),
                            ...
                            L.bindMethods(r),
                            r.supportsDataObject && void 0 !== s.data().sortlist
                                ? (r.sortList = s.data().sortlist)
                                : a &&
                                  s.metadata() &&
                                  s.metadata().sortlist &&
                                  (r.sortList = s.metadata().sortlist),
                            L.applyWidget(t, !0),
                            0 < r.sortList.length
                ...
                bindEvents: function (e, t, r) {
                    ...
                    !0 !== r &&
                        ...
                        (o = L.getClosest(t, 'table')).length &&
                            'TABLE' === o[0].nodeName &&
                            o[0] !== e &&
                            A(o[0]).addClass(s.slice(1) + '_extra_table')),
                        (o = (
                            i.pointerDown +
                            ' ' +
                            i.pointerUp +
                ...
                buildHeaders: function (d) {
                    ...
                    for (
                        d.headerList = [],
                            ...
                            d.$headers = A(
                                A.map(
                                    d.$table.find(d.selectorHeaders),
                                    function (e, t) {
                                        var r,
                                            o,
                                            s,
                ...
                getColumnText: function (e, t, r, o) {
                    ...
                    if (!L.isEmptyObject(b)) {
                        for (d = b.$tbodies.length, s = 0; s < d; s++)
                            for (
                                l = (n = b.cache[s].normalized).length, a = 0;
                                a < l;
                                a++
                            )
                                (i = n[a]),
                ...
                setHeadersCss: function (a) {
                    ...
                    var t,
                        ...
                        i = [
                            L.css.sortAsc + ' ' + a.cssAsc,
                            L.css.sortDesc + ' ' + a.cssDesc,
                        ],
                ...
                addRows: function (e, t, r, o) {
                    ...
                    if (b) (t = A(t)), e.$tbodies.append(t);
                        ...
                        !(
                            t &&
                            t instanceof A &&
                            L.getClosest(t, 'table')[0] === e.table
                        )
                    )
                        return (
                            L.debug(e, 'core') &&
                ...
                initSort: function (t, e, r) {
                    ...
                    if (c) {
                        if (
                            ...
                            for (o = t.sortForce, s = 0; s < o.length; s++)
                                o[s][0] !== f &&
                    ...
                    if (
                        ...
                        t.sortList.length &&
                            t.sortAppend &&
                            ((o = A.isArray(t.sortAppend)
                                ? t.sortAppend
                                : t.sortAppend[t.sortList[0][0]]),
                            !L.isEmptyObject(o)))
                    )
                        for (s = 0; s < o.length; s++)
                            if (
                                o[s][0] !== f &&
                                L.isValueInArray(o[s][0], t.sortList) < 0
                            ) {
                                if (
                                    (i = ('' + (n = o[s][1])).match(
                                        /^(a|d|s|o|n)/,
                ...
                applyWidgetId: function (e, t, r) {
                    ...
                    l &&
                        ((a = l.id),
                        (o = !1),
                        A.inArray(a, n.widgets) < 0 &&
                            (n.widgets[n.widgets.length] = a),
                        d && (s = new Date()),
                        (!r && n.widgetInit[a]) ||
                            ((n.widgetInit[a] = !0),
                ...
                applyWidget: function (e, t, r) {
                    ...
                    if (
                        !1 === t ||
                        !e.hasInitialized ||
                        (!e.isApplyingWidgets && !e.isUpdating)
                    ) {
                        if (
                            (l && (i = new Date()),
                            ...
                            for (
                                ...
                                (n = L.getWidgetById(a[o])) && n.id
                                    ? (n.priority || (n.priority = 10),
                                      (c[o] = n))
                                    : l &&
                                      console.warn(
                                          '"' +
                ...
                formatFloat: function (e, t) {
                    return 'string' != typeof e || '' === e
                        ...
                        : ((e = (
                              t && t.config
                                  ? !1 !== t.config.usNumberFormat
                                  : void 0 === t || t
                          )
                              ? e.replace(L.regex.comma, '')
                              : e
                                    .replace(L.regex.digitNonUS, '')
                                    .replace(L.regex.comma, '.')),
                    ...
                    for (r = 0; r < e.length; r++)
                        for (i = e[r].cells, o = 0; o < i.length; o++) {
                            ...
                            for (
                                (p && n.cellIndex === g) ||
                                    (n.setAttribute
                                        ? n.setAttribute('data-column', g)
                                        : A(n).attr('data-column', g)),
                                    s = d;
                                s < d + l;
                                s++
                            )
                ...
                fixColumnWidth: function (e) {
                    ...
                    if (
                        ...
                        n.widthFixed &&
                            0 === n.$table.children('colgroup').length)
                    ) {
                        for (
                            i = A('<colgroup class="' + L.css.colgroup + '">'),
                                t = n.$table.width(),
                                s = (o = n.$tbodies
                                    .find('tr:first')
                    ...
                    if ((e = A(e)[0]).hasInitialized) {
                        ...
                        !1 === t &&
                            ...
                            s
                                ...
                                .unbind(o.replace(L.regex.spaces, ' ')),
                            a.$headers
                                .add(d)
                                .removeClass(
                                    [
