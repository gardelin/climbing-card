    ...
    function init(plot) {
        ...
        function checkPieEnabled(plot, options) {
            if (options.series.pie.show) {
                ...
                if (options.series.pie.tilt < 0) options.series.pie.tilt = 0;
        ...
        function setupPie() {
            ...
            maxRadius =
                Math.min(
                    canvas.width,
                    canvas.height / options.series.pie.tilt,
                ) / 2;
            ...
            else centerLeft += options.series.pie.offset.left;
        ...
        function combine(data) {
            ...
            for (var i = 0; i < data.length; ++i) {
                ...
                if (!data[i].data[0][1]) data[i].data[0][1] = 0;

                if (
                    data[i].data[0][1] / total <=
        ...
        function draw(plot, newCtx) {
            ...
            while (redraw && attempts < redrawAttempts) {
                redraw = false;
                if (attempts > 0) maxRadius *= shrink;
                attempts += 1;
                clear();
            ...
            function drawShadow() {
                ...
                else var radius = maxRadius * options.series.pie.radius;

                if (
                    radius >= canvas.width / 2 - shadowLeft ||
                    radius * options.series.pie.tilt >=
                        canvas.height / 2 - shadowTop ||
                    radius <= edge
                )
            ...
            function drawPie() {
                ...
                // draw labels
                if (options.series.pie.label.show) drawLabels();
                ...
                function drawSlice(angle, color, fill) {
                    ...
                    if (Math.abs(angle - Math.PI * 2) > 0.000000001)
                        ctx.moveTo(0, 0);
                    // Center of the pie
                    else if ($.browser.msie) angle -= 0.0001;
                ...
                function drawLabels() {
                    ...
                    function drawLabel(slice, startAngle, index) {
                        ...
                        if (
                            0 - labelTop > 0 ||
                            0 - labelLeft > 0 ||
                            canvas.height - (labelTop + label.height()) < 0 ||
