    ...
    function Plot(placeholder, data_, options_, plugins) {
        ...
        function measureTickLabels(axis) {
            ...
            if (axis.direction == 'x') {
                ...
                if (w == null)
                    w = Math.floor(
                        canvasWidth / (ticks.length > 0 ? ticks.length : 1),
                    );
        ...
        function setupTickGeneration(axis) {
            ...
            if (opts.mode == 'time') {
                ...
                generator = function (axis) {
                    ...
                    if (unit == 'second')
                        d.setUTCSeconds(
                            floorInBase(d.getUTCSeconds(), tickSize),
                        );
                    if (unit == 'minute')
                        d.setUTCMinutes(
                            floorInBase(d.getUTCMinutes(), tickSize),
                        );
                    if (unit == 'hour')
                    ...
                    if (unit == 'year')
                        d.setUTCFullYear(
                            floorInBase(d.getUTCFullYear(), tickSize),
                        );
