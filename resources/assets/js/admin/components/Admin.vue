<template>
    ...
    <div class="table-footer">
        <Pagination :store-namespace="'admin'" :current-page="currentPage" :total="total" :per-page="perPage" />
    </div>
</template>
...
<script setup>
    ...
    const cards = computed(() => store.getters['admin/filterCards']({ searchQuery, dateRange }));
